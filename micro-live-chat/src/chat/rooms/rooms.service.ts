...
export class RoomsService implements OnGatewayInit {
    ...
    async onJoin(
        ...
        try {
            ...
            if (password) {
                // comunicacao rpc chamndo o validate
            ...
            // conectando o usuario na sala da live no socket
            client.join(room);
            console.log('join', client.id);

            // salvando as informacoes do cliente na live
            ...
            // buscar todas as mensagens do chat com base no slug da live
            const messages = await this.chatMessageRepo.find({
                where: {live_slug: room},
                order: {created_at: 'ASC'}
            });

            // emite para o proprio cliente que esta conectado
    ...
    async sendMessage(
        ...
        try {
            ...
            // pegando o id do cliente no redis, para verificar se ele esta dentro da live
            ...
            // quando ele enviar mensagem para o chat bot
            if (data.content.startsWith('/')) {
                ...
                service
                    ...
                    .then((result) => {
                        ...
                        // socket envia mensagem para o proprio cliente que enviou a mensagem
            ...
            // dispara mensagem no chat de todos os usuarios conectador na sala da live
            ...
            // publicacao mensagem na fila do rabbitmq
